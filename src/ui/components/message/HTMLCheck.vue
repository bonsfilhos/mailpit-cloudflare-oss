									...
									<div class="accordion-body">
										...
										<p>
											...
											<a href="https://github.com/vanng822/go-premailer" target="_blank"
												>inlined</a
											>
											to matching HTML elements. This gives Mailpit Cloudflare fairly accurate results.
										</p>
										<p>
											...
											within CSS blocks. This method is not accurate as Mailpit Cloudflare does not know how
							...
							<div class="accordion-item">
								...
								>
									<div class="accordion-body">
										...
										<p>
											For each test, Mailpit Cloudflare calculates both the unsupported & partially-supported
										...
										<p>
											Mailpit Cloudflare will sort the warnings according to their weighted unsupported
											scores.
										</p>
									</div>
								</div>
