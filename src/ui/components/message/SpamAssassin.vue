					...
					<div id="SpamAnalysisAboutAccordion" class="accordion">
						<div class="accordion-item">
							...
							>
								<div class="accordion-body">
									<p>
										Mailpit Cloudflare integrates with SpamAssassin to provide you with some insight into the
						...
						<div class="accordion-item">
							...
							>
								<div class="accordion-body">
									<p>
										Mailpit Cloudflare does not manipulate the results nor determine the "spamminess" of your
