	...
	<template v-if="!modals">
		<div class="bg-body ms-sm-n1 me-sm-n1 py-2 text-muted small about-mailpit">
			...
			<button
				...
				title="Mailpit Cloudflare UI settings"
			>
								...
								<div class="row g-3">
									<div class="col-xl-6">
											...
											>
												<div class="col">
													...
													>
														...
														>
															Latest stable Mailpit Cloudflare ({{ mailbox.appInfo.LatestVersion }})
															release
														</template>
														<template v-else>
															A new version of Mailpit Cloudflare ({{
																mailbox.appInfo.LatestVersion
															}}) is available
														</template>
													</a>
										...
										<div class="row g-3">
											...
											:href="mailbox.uiConfig.SourceURL"
													target="_blank"
												>
											...
											<div class="col-sm-6">
												<a
													class="btn btn-primary w-100"
											:href="mailbox.uiConfig.SourceURL + '/tree/main/docs'"
													target="_blank"
												>
													Documentation
												</a>
										...
										<div class="card border-secondary h-100">
											...
											<div class="card-body text-muted">
												<table class="table table-sm table-borderless mb-0">
													<tbody>
														<tr>
															<td>Mailpit Cloudflare up since</td>
															<td>
																{{
																	secondsToRelative(
														...
														<tr>
													<td>Inbound messages accepted</td>
															<td>
																{{
																	formatNumber(
														...
														<tr>
													<td>Inbound messages rejected</td>
															<td>
																{{
																	formatNumber(
		...
		>
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p class="h4">Get browser notifications when Mailpit Cloudflare receives new messages?</p>
						<p>
							Note that your browser will ask you for confirmation when you click
							<code>enable notifications</code>, and that you must have Mailpit Cloudflare open in a browser tab to
