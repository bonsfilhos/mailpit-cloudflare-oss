		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 id="SettingsModalLabel" class="modal-title">Mailpit Cloudflare settings</h5>
				...
				<div class="modal-body">
					...
					<div class="tab-content">
						...
						>
							<div class="my-3">
								<label for="theme" class="form-label">Mailpit Cloudflare theme</label>
							...
							<div class="mb-3">
								<div class="form-check form-switch">
									...
									<label class="form-check-label" for="htmlCheck">
										HTML compatibility scoring requires an external analyzer
									</label>
								</div>
							</div>
							<div class="mb-3">
